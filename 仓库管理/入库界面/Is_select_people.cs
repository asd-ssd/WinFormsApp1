...
{
    public partial class Is_select_people : Form
    {
        private string Is_select_people_name;
        private string Is_select_people_number;
        public TextBox Is_select_people_textBox1 = Is_add.is_Add1.textBox15;//绑定is_add的入库人格
        public TextBox Is_select_people_textBox2 = Is_add.is_Add1.textBox3;
        public Is_select_people()
        {
            InitializeComponent();
        }
        ...
        private void Is_select_people_Load(object sender, EventArgs e)
        {
            GetDataGridView();
        }
