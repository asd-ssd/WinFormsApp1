...
{
    public partial class OSPeople : Form
    {
        private int n;
        private string[] strcomm;
        private string RTselect_people_number;

        public TextBox RTselect_people_textBox3 = Order2nd.order2Nd.textBox3;
        public OSPeople()
        {
            InitializeComponent();
            GetDataGridView();
        ...
        {
            RTselect_people_textBox3.Text = RTselect_people_number;
            this.Close();
        }
        ...
        private void OSPeople_Load(object sender, EventArgs e)
        {
